...
public class WorldgenAutoSetup extends FabricDynamicRegistryProvider {
    public WorldgenAutoSetup(FabricDataOutput output, CompletableFuture<RegistryWrapper.WrapperLookup> registriesFuture) {
